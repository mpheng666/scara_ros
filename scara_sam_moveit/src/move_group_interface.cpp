...
int main(int argc, char** argv)
{
  ...
  joint_pub = node_handle.advertise<std_msgs::Int32>("joint_msg", 1);
  mission_pub = node_handle.advertise<std_msgs::Int32>("mission_msg", 1);
  ...
  moveit_visual_tools::MoveItVisualTools visual_tools("link_3");
  ...
  visual_tools.publishText(text_pose, "Scara Demo", rvt::WHITE, rvt::XLARGE);
  ...
  // ROS_INFO_NAMED("scara", "End effector link: %s", move_group.getEndEffectorLink().c_str());
  ...
  visual_tools.publishAxisLabeled(home_pose, "home_pose");
